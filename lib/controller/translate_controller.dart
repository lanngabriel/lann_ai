...
class TranslateController extends GetxController {
  ...
  Future<void> googleTranslate() async {
    if (textC.text.trim().isNotEmpty && to.isNotEmpty) {
      ...
      status.value = Status.none;
      if ((to.isEmpty) && (textC.text.isEmpty)) {
        MyDialog.error('Please fill it up');
      }
      else if ((to.isEmpty) && (textC.text.isNotEmpty)) {
        MyDialog.info('Please Select Language');
      }
      else if ((to.isNotEmpty) && (textC.text.isEmpty)) {
        MyDialog.info('Type Something');
      }
    }
  }
